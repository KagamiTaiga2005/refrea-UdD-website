...
document.querySelector('.js-slider-container')
  .addEventListener('mouseover', () => {
    prevButton.classList.add('prev-opacity');
    nextButton.classList.add('next-opacity')
});

document.querySelector('.js-slider-container')
  .addEventListener('mouseout', () => {
    prevButton.classList.remove('prev-opacity');
    nextButton.classList.remove('next-opacity');
});
...
document.querySelector('.js-partners-scroll')
  .addEventListener('click', () => {
